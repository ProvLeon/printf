...
This **Project** is a custom made printf function for the C programming language called \_printf. It is optimized to take inputs and optional arguments based on how the standard library function printf works. 

This was submitted as part of the ALX software engineering course requirement for grading.

## **Synopsis**
The function **\_printf()** writes output to stdout, the standard output stream with the format and options without making use of any of the standard library files. It was written to use a local buffer of 1024 bytes when printing although it can print larger sets of data.
...
## **Authors**
**Emmanuel Lomotey** and **Eweka Osagbemwonrhue**
